...
namespace Nova_Tools
{
    public partial class Factura : Form
    {
        ...
        DataRow row;
        int numar_factura;
        string client = "", produse = "", cantitati = "", preturi_vanzare = "", discounts = "", ums = "", valuta = "", comentarii = "";
        DateTime data;
        ...
        void draw_basic(System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            stringSize = g.MeasureString(comentarii, font_normal);
            g.DrawString(comentarii, font_normal_bold, Brushes.Black, new Point(75, height_bottom - 20 - 3 - Convert.ToInt32(stringSize.Height)));
